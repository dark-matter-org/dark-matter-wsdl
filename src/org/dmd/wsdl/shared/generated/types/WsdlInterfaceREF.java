...
import org.dmd.wsdl.shared.generated.dmo.WsdlInterfaceDMO; // primitive type
...
public class WsdlInterfaceREF extends DmcNamedObjectNontransportableREF<WsdlInterfaceDMO> {
    ...
    public WsdlInterfaceREF(){
    }

    public WsdlInterfaceREF(WsdlInterfaceDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public WsdlInterfaceREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public WsdlInterfaceREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public WsdlInterfaceREF(WsdlInterfaceREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(WsdlInterfaceDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public WsdlInterfaceREF cloneMe(){
