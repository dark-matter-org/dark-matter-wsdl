...
/**
 * The DmcTypeXmlElementREFMV provides storage for a multi-valued XmlElementREF
 * <P>
...
public class DmcTypeXmlElementREFMV extends DmcTypeXmlElementREF implements Serializable {
    
    private final static Iterator<XmlElementREF> emptyList = (new ArrayList<XmlElementREF>()).iterator();
    
    protected ArrayList<XmlElementREF> value;
    
    public DmcTypeXmlElementREFMV(){
    
    }
    
    public DmcTypeXmlElementREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeXmlElementREFMV getNew(){
        return(new DmcTypeXmlElementREFMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<XmlElementREF> cloneIt(){
        synchronized(this){
            DmcTypeXmlElementREFMV rc = getNew();
    ...
    public XmlElementREF add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<XmlElementREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<XmlElementREF> getMV(){
        synchronized(this){
            ...
            ArrayList<XmlElementREF> clone = new ArrayList<XmlElementREF>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2436)
    public ArrayList<XmlElementREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<XmlElementREF>());
            else 
                return(new ArrayList<XmlElementREF>(value));
        }
    }
    ...
    public XmlElementREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public XmlElementREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<XmlElementREF>(getAttributeInfo().indexSize);
