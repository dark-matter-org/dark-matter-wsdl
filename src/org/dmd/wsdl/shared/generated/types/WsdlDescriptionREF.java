...
import org.dmd.wsdl.shared.generated.dmo.WsdlDescriptionDMO; // primitive type
...
public class WsdlDescriptionREF extends DmcNamedObjectNontransportableREF<WsdlDescriptionDMO> {
    ...
    public WsdlDescriptionREF(){
    }

    public WsdlDescriptionREF(WsdlDescriptionDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public WsdlDescriptionREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public WsdlDescriptionREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public WsdlDescriptionREF(WsdlDescriptionREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(WsdlDescriptionDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public WsdlDescriptionREF cloneMe(){
