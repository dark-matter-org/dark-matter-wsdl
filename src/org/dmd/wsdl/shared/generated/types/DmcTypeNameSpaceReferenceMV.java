...
/**
 * The DmcTypeNameSpaceReferenceMV provides storage for a multi-valued NameSpaceReference
 * <P>
...
public class DmcTypeNameSpaceReferenceMV extends DmcTypeNameSpaceReference implements Serializable {
    
    private final static Iterator<NameSpaceReference> emptyList = (new ArrayList<NameSpaceReference>()).iterator();
    
    protected ArrayList<NameSpaceReference> value;
    
    public DmcTypeNameSpaceReferenceMV(){
    
    }
    
    public DmcTypeNameSpaceReferenceMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeNameSpaceReferenceMV getNew(){
        return(new DmcTypeNameSpaceReferenceMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<NameSpaceReference> cloneIt(){
        synchronized(this){
            DmcTypeNameSpaceReferenceMV rc = getNew();
    ...
    public NameSpaceReference add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<NameSpaceReference>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<NameSpaceReference> getMV(){
        synchronized(this){
            ...
            ArrayList<NameSpaceReference> clone = new ArrayList<NameSpaceReference>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2436)
    public ArrayList<NameSpaceReference> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<NameSpaceReference>());
            else 
                return(new ArrayList<NameSpaceReference>(value));
        }
    }
    ...
    public NameSpaceReference getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public NameSpaceReference setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<NameSpaceReference>(getAttributeInfo().indexSize);
