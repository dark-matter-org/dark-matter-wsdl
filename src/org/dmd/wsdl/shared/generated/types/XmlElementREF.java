...
import org.dmd.wsdl.shared.generated.dmo.XmlElementDMO; // primitive type
...
public class XmlElementREF extends DmcNamedObjectNontransportableREF<XmlElementDMO> {
    ...
    public XmlElementREF(XmlElementDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public XmlElementREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public XmlElementREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public XmlElementREF(XmlElementREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(XmlElementDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
