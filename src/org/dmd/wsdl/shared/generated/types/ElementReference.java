...
public class ElementReference implements Serializable {
     ...
     */
    public ElementReference(String nameSpace_, XsElementREF element_) throws DmcValueException {
    ...
    void initialize(String initialInput) throws DmcValueException {
        ...
        if (nvp.size() < requiredParts)
            throw(new DmcValueException("Missing required values for complex type: ElementReference"));
