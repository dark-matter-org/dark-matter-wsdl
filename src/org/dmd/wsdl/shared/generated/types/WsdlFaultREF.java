...
import org.dmd.wsdl.shared.generated.dmo.WsdlFaultDMO; // primitive type
...
public class WsdlFaultREF extends DmcNamedObjectNontransportableREF<WsdlFaultDMO> {
    ...
    public WsdlFaultREF(WsdlFaultDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public WsdlFaultREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public WsdlFaultREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public WsdlFaultREF(WsdlFaultREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(WsdlFaultDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
