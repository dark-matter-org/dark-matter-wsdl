...
/**
 * The DmcTypeWsdlOperationREFMV provides storage for a multi-valued WsdlOperationREF
 * <P>
...
public class DmcTypeWsdlOperationREFMV extends DmcTypeWsdlOperationREF implements Serializable {
    
    private final static Iterator<WsdlOperationREF> emptyList = (new ArrayList<WsdlOperationREF>()).iterator();
    
    protected ArrayList<WsdlOperationREF> value;
    
    public DmcTypeWsdlOperationREFMV(){
    
    }
    
    public DmcTypeWsdlOperationREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeWsdlOperationREFMV getNew(){
        return(new DmcTypeWsdlOperationREFMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<WsdlOperationREF> cloneIt(){
        synchronized(this){
            DmcTypeWsdlOperationREFMV rc = getNew();
    ...
    public WsdlOperationREF add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<WsdlOperationREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<WsdlOperationREF> getMV(){
        synchronized(this){
            ...
            ArrayList<WsdlOperationREF> clone = new ArrayList<WsdlOperationREF>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2436)
    public ArrayList<WsdlOperationREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<WsdlOperationREF>());
            else 
                return(new ArrayList<WsdlOperationREF>(value));
        }
    }
    ...
    public WsdlOperationREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public WsdlOperationREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<WsdlOperationREF>(getAttributeInfo().indexSize);
