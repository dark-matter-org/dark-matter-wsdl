...
import org.dmd.wsdl.shared.generated.dmo.XsSchemaDMO; // primitive type
...
public class XsSchemaREF extends DmcNamedObjectNontransportableREF<XsSchemaDMO> {
    ...
    public XsSchemaREF(XsSchemaDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public XsSchemaREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public XsSchemaREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public XsSchemaREF(XsSchemaREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(XsSchemaDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
