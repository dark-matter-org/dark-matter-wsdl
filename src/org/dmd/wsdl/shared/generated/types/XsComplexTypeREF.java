...
import org.dmd.wsdl.shared.generated.dmo.XsComplexTypeDMO; // primitive type
...
public class XsComplexTypeREF extends DmcNamedObjectNontransportableREF<XsComplexTypeDMO> {
    ...
    public XsComplexTypeREF(){
    }

    public XsComplexTypeREF(XsComplexTypeDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public XsComplexTypeREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public XsComplexTypeREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public XsComplexTypeREF(XsComplexTypeREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(XsComplexTypeDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public XsComplexTypeREF cloneMe(){
