...
/**
 * The DmcTypeLabelledFaultReferenceMV provides storage for a multi-valued LabelledFaultReference
 * <P>
...
public class DmcTypeLabelledFaultReferenceMV extends DmcTypeLabelledFaultReference implements Serializable {
    
    private final static Iterator<LabelledFaultReference> emptyList = (new ArrayList<LabelledFaultReference>()).iterator();
    
    protected ArrayList<LabelledFaultReference> value;
    
    public DmcTypeLabelledFaultReferenceMV(){
    
    }
    
    public DmcTypeLabelledFaultReferenceMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeLabelledFaultReferenceMV getNew(){
        return(new DmcTypeLabelledFaultReferenceMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<LabelledFaultReference> cloneIt(){
        synchronized(this){
            DmcTypeLabelledFaultReferenceMV rc = getNew();
    ...
    public LabelledFaultReference add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<LabelledFaultReference>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public LabelledFaultReference del(Object v){
        synchronized(this){
            ...
            LabelledFaultReference key = null;
    ...
    public Iterator<LabelledFaultReference> getMV(){
        synchronized(this){
            ...
            ArrayList<LabelledFaultReference> clone = new ArrayList<LabelledFaultReference>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2436)
    public ArrayList<LabelledFaultReference> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<LabelledFaultReference>());
            else 
                return(new ArrayList<LabelledFaultReference>(value));
        }
    }
    ...
    public LabelledFaultReference getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public LabelledFaultReference setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<LabelledFaultReference>(getAttributeInfo().indexSize);
