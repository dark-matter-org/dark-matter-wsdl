...
import org.dmd.wsdl.shared.generated.dmo.WsdlBindingDMO; // primitive type
...
public class WsdlBindingREF extends DmcNamedObjectNontransportableREF<WsdlBindingDMO> {
    ...
    public WsdlBindingREF(){
    }

    public WsdlBindingREF(WsdlBindingDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public WsdlBindingREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public WsdlBindingREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public WsdlBindingREF(WsdlBindingREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(WsdlBindingDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
