...
import org.dmd.wsdl.shared.generated.dmo.WsdlDefinitionDMO; // primitive type
...
public class WsdlDefinitionREF extends DmcNamedObjectNontransportableREF<WsdlDefinitionDMO> {
    ...
    public WsdlDefinitionREF(){
    }

    public WsdlDefinitionREF(WsdlDefinitionDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public WsdlDefinitionREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public WsdlDefinitionREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public WsdlDefinitionREF(WsdlDefinitionREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(WsdlDefinitionDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public WsdlDefinitionREF cloneMe(){
