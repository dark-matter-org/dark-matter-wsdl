...
import org.dmd.wsdl.shared.generated.dmo.XsElementDMO; // primitive type
...
public class XsElementREF extends DmcNamedObjectNontransportableREF<XsElementDMO> {
    ...
    public XsElementREF(XsElementDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public XsElementREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public XsElementREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public XsElementREF(XsElementREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(XsElementDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
