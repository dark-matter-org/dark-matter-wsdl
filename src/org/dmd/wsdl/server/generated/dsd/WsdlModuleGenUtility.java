...
import org.dmd.wsdl.server.generated.dsd.WsdlModuleGeneratorInterface;         // Called by the parsing coordinator as configs are read - (DSDArtifactFormatter.java:1037)
import org.dmd.wsdl.server.generated.dsd.WsdlModuleParsingCoordinator;         // Parses modules required for generation - (DSDArtifactFormatter.java:1036)
...
public abstract class WsdlModuleGenUtility implements WsdlModuleGeneratorInterface {
    ...
    StringArrayList                 jars           = new StringArrayList();   // The jars that will be searched for .dmwsdl config files
    ...
    public void run(String[] args) throws ResultException, DmcValueException, IOException, DmcRuleExceptionSet, DmcNameClashException, DmcValueExceptionSet {
        ...
        parser = new WsdlModuleParsingCoordinator(this, srcdir,jars);
