...
import org.dmd.wsdl.server.generated.dsd.WsdlModuleGeneratorInterface;         // Called by the parsing coordinator as configs are read - (DSDArtifactFormatter.java:1059)
import org.dmd.wsdl.server.generated.dsd.WsdlModuleParsingCoordinator;         // Parses modules required for generation - (DSDArtifactFormatter.java:1058)


// Generated from: org.dmd.dmg.generators.DSDArtifactFormatter.generateBaseUtility(DSDArtifactFormatter.java:1086)
public abstract class WsdlModuleGenUtility implements WsdlModuleGeneratorInterface {
    ...
    WsdlModuleParsingCoordinator    parser;                                   // Module parser
    ...
    protected StringArrayList       jars           = new StringArrayList();   // The jars that will be searched for .dmwsdl config files

    protected WsdlModuleGenUtility() {
        ...
        commandLine.addOption("-jars",      jars,     	"The prefixs of jars to search for .dmwsdl config files.");
    ...
    public void run(String[] args) throws ResultException, DmcValueException, IOException, DmcRuleExceptionSet, DmcNameClashException, DmcValueExceptionSet {
        ...
        parser = new WsdlModuleParsingCoordinator(this, withWorkspace, jars);
