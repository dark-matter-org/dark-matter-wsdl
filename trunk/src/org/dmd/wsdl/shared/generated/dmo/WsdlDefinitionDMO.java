...
import org.dmd.wsdl.shared.generated.types.DmcTypeWsdlModuleREFSV;         // Reference type - (GenUtility.java:300)
...
abstract public class WsdlDefinitionDMO  extends DSDefinitionDMO  implements DmcNamedObjectIF, Serializable  {

    public final static String constructionClassName = "WsdlDefinition";


    static {
    }

    public WsdlDefinitionDMO() {
        super("WsdlDefinition");
    }

    protected WsdlDefinitionDMO(String oc) {
        super(oc);
    }
    ...
    public boolean equals(Object obj){
        if (obj instanceof WsdlDefinitionDMO){
            return( getObjectName().equals( ((WsdlDefinitionDMO) obj).getObjectName()) );
        }
        return(false);
    }
    ...
    public WsdlModuleREF getDefinedInWsdlModule(){
        DmcTypeWsdlModuleREFSV attr = (DmcTypeWsdlModuleREFSV) get(DmwsdlDMSAG.__definedInWsdlModule);
        if (attr == null)
            return(null);
    ...
    /**
     * Returns the reference to WsdlModule without attempting lazy resolution (if turned on).
     */
    public WsdlModuleREF getDefinedInWsdlModuleREF(){
        DmcTypeWsdlModuleREFSV attr = (DmcTypeWsdlModuleREFSV) get(DmwsdlDMSAG.__definedInWsdlModule);
        if (attr == null)
            return(null);
    ...
    /**
     * Sets definedInWsdlModule to the specified value.
     * @param value WsdlModuleDMO
     */
    // org.dmd.dms.util.GenUtility.formatSV(GenUtility.java:709)
    public void setDefinedInWsdlModule(WsdlModuleDMO value) {
        DmcAttribute<?> attr = get(DmwsdlDMSAG.__definedInWsdlModule);
        if (attr == null)
            attr = new DmcTypeWsdlModuleREFSV(DmwsdlDMSAG.__definedInWsdlModule);
        else
            ((DmcTypeWsdlModuleREFSV)attr).removeBackReferences();
        
        try{
            attr.set(value);
            set(DmwsdlDMSAG.__definedInWsdlModule,attr);
        }
        catch(DmcValueException ex){
            throw(new IllegalStateException("The type specific set() method shouldn't throw exceptions!",ex));
        }
    ...
    /**
     * Sets definedInWsdlModule to the specified value.
     * @param value A value compatible with DmcTypeWsdlModuleREFSV
     */
    // org.dmd.dms.util.GenUtility.formatSV(GenUtility.java:877)
    ...
    public void remDefinedInWsdlModule(){
         rem(DmwsdlDMSAG.__definedInWsdlModule);
    }
