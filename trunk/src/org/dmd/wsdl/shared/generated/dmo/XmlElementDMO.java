...
import org.dmd.dms.generated.types.DmcTypeTypeDefinitionREFSV;         // Reference type - (GenUtility.java:300)
...
public class XmlElementDMO  extends WsdlDefinitionDMO  implements DmcNamedObjectIF, Serializable  {

    public final static String constructionClassName = "XmlElement";


    static {
    }

    public XmlElementDMO() {
        super("XmlElement");
    }

    protected XmlElementDMO(String oc) {
        super(oc);
    }

    @Override
    public XmlElementDMO getNew(){
        XmlElementDMO rc = new XmlElementDMO();
        return(rc);
    }

    @Override
    public XmlElementDMO getSlice(DmcSliceInfo info){
        XmlElementDMO rc = new XmlElementDMO();
        populateSlice(rc,info);
        return(rc);
    }

    public XmlElementDMO(DmcTypeModifierMV mods) {
        super("XmlElement");
        modrec(true);
        setModifier(mods);
    }

    public XmlElementDMO getModificationRecorder(){
        XmlElementDMO rc = new XmlElementDMO();
        rc.setName(getName());
    ...
    public boolean equals(Object obj){
        if (obj instanceof XmlElementDMO){
            return( getObjectName().equals( ((XmlElementDMO) obj).getObjectName()) );
        }
        return(false);
    }
    ...
    /**
     * Returns the reference to TypeDefinition without attempting lazy resolution (if turned on).
     */
    public TypeDefinitionREF getTypeREF(){
        DmcTypeTypeDefinitionREFSV attr = (DmcTypeTypeDefinitionREFSV) get(MetaDMSAG.__type);
        if (attr == null)
            return(null);
