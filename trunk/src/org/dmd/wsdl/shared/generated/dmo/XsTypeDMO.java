...
public class XsTypeDMO  extends WsdlDefinitionDMO  implements DmcNamedObjectIF, Serializable  {

    public final static String constructionClassName = "XsType";
    ...
    protected XsTypeDMO(String oc) {
        super(oc);
    }

    @Override
    public XsTypeDMO getNew(){
        XsTypeDMO rc = new XsTypeDMO();
        return(rc);
    }

    @Override
    public XsTypeDMO getSlice(DmcSliceInfo info){
        XsTypeDMO rc = new XsTypeDMO();
        populateSlice(rc,info);
        return(rc);
    }

    public XsTypeDMO(DmcTypeModifierMV mods) {
        super("XsType");
        modrec(true);
        setModifier(mods);
    }

    public XsTypeDMO getModificationRecorder(){
        XsTypeDMO rc = new XsTypeDMO();
        rc.setName(getName());
    ...
    public boolean equals(Object obj){
        if (obj instanceof XsTypeDMO){
            return( getObjectName().equals( ((XsTypeDMO) obj).getObjectName()) );
        }
        return(false);
    }
    ...
    public String getPrefix(){
        DmcTypeStringSV attr = (DmcTypeStringSV) get(DmwsdlDMSAG.__prefix);
        if (attr == null)
            return(null);
    ...
    public void setPrefix(String value) {
        DmcAttribute<?> attr = get(DmwsdlDMSAG.__prefix);
        if (attr == null)
            attr = new DmcTypeStringSV(DmwsdlDMSAG.__prefix);
        
        try{
            attr.set(value);
            set(DmwsdlDMSAG.__prefix,attr);
        }
