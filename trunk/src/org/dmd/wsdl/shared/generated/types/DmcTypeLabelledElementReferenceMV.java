...
/**
 * The DmcTypeLabelledElementReferenceMV provides storage for a multi-valued LabelledElementReference
 * <P>
...
public class DmcTypeLabelledElementReferenceMV extends DmcTypeLabelledElementReference implements Serializable {
    
    private final static Iterator<LabelledElementReference> emptyList = (new ArrayList<LabelledElementReference>()).iterator();
    
    protected ArrayList<LabelledElementReference> value;
    
    public DmcTypeLabelledElementReferenceMV(){
    
    }
    
    public DmcTypeLabelledElementReferenceMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeLabelledElementReferenceMV getNew(){
        return(new DmcTypeLabelledElementReferenceMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<LabelledElementReference> cloneIt(){
        synchronized(this){
            DmcTypeLabelledElementReferenceMV rc = getNew();
    ...
    public LabelledElementReference add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<LabelledElementReference>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public LabelledElementReference del(Object v){
        synchronized(this){
            ...
            LabelledElementReference key = null;
    ...
    public Iterator<LabelledElementReference> getMV(){
        synchronized(this){
            ...
            ArrayList<LabelledElementReference> clone = new ArrayList<LabelledElementReference>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2436)
    public ArrayList<LabelledElementReference> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<LabelledElementReference>());
            else 
                return(new ArrayList<LabelledElementReference>(value));
        }
    }
    ...
    public LabelledElementReference getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public LabelledElementReference setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<LabelledElementReference>(getAttributeInfo().indexSize);
