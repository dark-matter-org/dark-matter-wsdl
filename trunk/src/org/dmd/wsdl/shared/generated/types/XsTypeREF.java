...
import org.dmd.wsdl.shared.generated.dmo.XsTypeDMO; // primitive type
...
public class XsTypeREF extends DmcNamedObjectNontransportableREF<XsTypeDMO> {
    ...
    public XsTypeREF(XsTypeDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public XsTypeREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public XsTypeREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public XsTypeREF(XsTypeREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(XsTypeDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
