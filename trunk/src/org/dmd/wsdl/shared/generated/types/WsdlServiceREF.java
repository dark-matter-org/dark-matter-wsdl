...
import org.dmd.wsdl.shared.generated.dmo.WsdlServiceDMO; // primitive type
...
public class WsdlServiceREF extends DmcNamedObjectNontransportableREF<WsdlServiceDMO> {
    ...
    public WsdlServiceREF(){
    }

    public WsdlServiceREF(WsdlServiceDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public WsdlServiceREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public WsdlServiceREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public WsdlServiceREF(WsdlServiceREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(WsdlServiceDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
