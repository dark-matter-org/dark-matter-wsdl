...
import org.dmd.wsdl.shared.generated.dmo.WsdlModuleDMO; // primitive type
...
public class WsdlModuleREF extends DmcNamedObjectNontransportableREF<WsdlModuleDMO> {
    ...
    public WsdlModuleREF(){
    }

    public WsdlModuleREF(WsdlModuleDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public WsdlModuleREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public WsdlModuleREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public WsdlModuleREF(WsdlModuleREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(WsdlModuleDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
