...
/**
 * The DmcTypeWsdlDescriptionREFMV provides storage for a multi-valued WsdlDescriptionREF
 * <P>
...
public class DmcTypeWsdlDescriptionREFMV extends DmcTypeWsdlDescriptionREF implements Serializable {
    
    private final static Iterator<WsdlDescriptionREF> emptyList = (new ArrayList<WsdlDescriptionREF>()).iterator();
    
    protected ArrayList<WsdlDescriptionREF> value;
    
    public DmcTypeWsdlDescriptionREFMV(){
    
    }
    
    public DmcTypeWsdlDescriptionREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeWsdlDescriptionREFMV getNew(){
        return(new DmcTypeWsdlDescriptionREFMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<WsdlDescriptionREF> cloneIt(){
        synchronized(this){
            DmcTypeWsdlDescriptionREFMV rc = getNew();
    ...
    public WsdlDescriptionREF add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<WsdlDescriptionREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<WsdlDescriptionREF> getMV(){
        synchronized(this){
            ...
            ArrayList<WsdlDescriptionREF> clone = new ArrayList<WsdlDescriptionREF>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2436)
    public ArrayList<WsdlDescriptionREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<WsdlDescriptionREF>());
            else 
                return(new ArrayList<WsdlDescriptionREF>(value));
        }
    }
    ...
    public WsdlDescriptionREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public WsdlDescriptionREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<WsdlDescriptionREF>(getAttributeInfo().indexSize);
